...
// fixing
#define BONGO_ANIM_SIZE                                                        \
    320 // number of bytes in array, minimize for adequate firmware size, max is
        // 1024
...
static void bongo_render_anim(void)
{
    ...
    void bongo_animation_phase(void)
    {
        ...
        {
            /*
            bongo_current_idle_frame = (bongo_current_idle_frame + 1) %
            BONGO_IDLE_FRAMES;
            oled_write_raw_P(idle[abs((BONGO_IDLE_FRAMES-1)-bongo_current_idle_frame)],
            BONGO_ANIM_SIZE);
            */
        ...
        {
            bongo_current_tap_frame =
                (bongo_current_tap_frame + 1) % BONGO_TAP_FRAMES;
            oled_write_raw_P(
                tap[abs((BONGO_TAP_FRAMES - 1) - bongo_current_tap_frame)],
                BONGO_ANIM_SIZE);
        }
    }
